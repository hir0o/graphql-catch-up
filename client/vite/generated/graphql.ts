...
export type GetTodoListQuery = { __typename?: 'Query', todos: Array<{ __typename?: 'Todo', title: string, id: string, done: boolean, labels: Array<{ __typename?: 'Label', id: string, name: string } | null> }> };
